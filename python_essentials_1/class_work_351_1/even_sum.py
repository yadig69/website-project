...
print(f"The for loop sum of even numbers from 1 to 50 is {even_sum}.")
...
even_sum = 0
# Initializes the counter variable to stat at 1
num = 1
# Uses a while loop to iterate through the numbers 1 to 51.
while num <= 50:
    # Determines if the current number is even.
    if num % 2 == 0:
    # Calculates the sum of all even numbers in that range.
      even_sum += num
# print(f"The while sum1 of even number from 1 to 50 is {even_sum}.")
      
    # Increments the counter to move to the next number.
# print(num)
    num += 1
    
print(f"The while sum of even number from 1 to 50 is {even_sum}.")
